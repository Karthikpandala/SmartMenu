...
const restaurants_controller_1 = require("./restaurants.controller"); // must exist
...
exports.RestaurantsModule = RestaurantsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([restaurant_entity_1.Restaurant, user_entity_1.User])],
