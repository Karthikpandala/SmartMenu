  ...
  const base = useMemo(() => {
    ...
    return menuItems.filter(
      (m) =>
        ...
        (active === "Coffee & Tea" &&
          (m.category === "Coffee" || m.category === "Tea")) ||
        (active === "Snacks" &&
          (m.category === "To Start With" ||
            m.category === "Momos" ||
            m.category === "Salads"))
    );
  }, [active]);
            ...
            <div className="w-full md:w-2/3 lg:w-3/4 md:pl-8">
              ...
              <div className="flex items-center mt-2">
                ...
                <div className="text-sm text-gray-500">
                  ₹₹ • Modern • Coffee & Snacks
                </div>
              </div>
              <p className="mt-4 text-gray-600">
                A cozy and aesthetic café offering handcrafted coffees,
                milkshakes, pizzas, and signature snacks. Perfect to chill,
                dine, or work with delicious food and warm vibes.
              </p>
              <div className="mt-4 flex items-center text-sm text-gray-500">
                <Clock className="w-4 h-4 mr-1" />
                <span>Open now • 10:00 AM – 11:00 PM</span>
              </div>
            </div>
          </div>
        </div>
