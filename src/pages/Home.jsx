...
export default function Home() {
  ...
  return (
    <>
      <Navbar title="QRMenu" right={
        <div className="flex items-center space-x-4">
          <Link to="/login" className="text-gray-600 hover:text-gray-900 px-3 py-2">Log In</Link>
          <Link to="/signup" className="bg-gray-800 text-white px-4 py-2 rounded-md hover:bg-gray-700">Sign Up</Link>
        </div>
      }/>
          ...
          <div className="text-center">
            ...
            <div className="mt-8 max-w-md mx-auto">
              <div className="relative rounded-md shadow-sm">
                ...
                <input type="text" className="focus:ring-gray-500 focus:border-gray-500 block w-full pl-10 pr-12 py-4 border-gray-300 rounded-md" placeholder="Search restaurants..." />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {[
            ...
            <div key={i} className="bg-white p-4 rounded-lg shadow-sm flex flex-col items-center hover:shadow-md transition-shadow">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow" data-aos="fade-up">
            <div className="relative h-48 bg-gray-200">
              <img src="http://static.photos/restaurant/640x360/1" alt="Restaurant" className="w-full h-full object-cover" />
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-600 mt-2">Contemporary dining with locally sourced ingredients and craft cocktails.</p>
              <div className="mt-4 flex justify-between items-center text-sm">
                <span className="text-gray-500">32 items</span>
                <Link to="/menu" className="text-gray-800 font-medium hover:text-gray-900">View Menu</Link>
              </div>
            </div>
          </div>
      ...
      <div className="bg-gray-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button
            ...
            className="bg-white text-gray-800 px-6 py-3 rounded-md font-medium hover:bg-gray-100"
          >
            Get Started Free
          </button>
        </div>
